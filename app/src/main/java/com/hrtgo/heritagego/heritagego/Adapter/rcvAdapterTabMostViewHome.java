...
public class rcvAdapterTabMostViewHome extends RecyclerView.Adapter<rcvAdapterTabMostViewHome.viewHolder>{

    ArrayList<LocationHome> locationHomes;
    Context context;

    public rcvAdapterTabMostViewHome(ArrayList<LocationHome> locationHomes, Context context) {
