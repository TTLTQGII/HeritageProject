...
public class rcvAdapterTabMyFavoriteHome extends RecyclerView.Adapter<rcvAdapterTabMyFavoriteHome.viewHolder>{

    ArrayList<LocationHome> locationHomes;
    Context context;

    public rcvAdapterTabMyFavoriteHome(ArrayList<LocationHome> locationHomes, Context context) {
