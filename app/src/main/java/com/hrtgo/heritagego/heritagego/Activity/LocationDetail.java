...
public class LocationDetail extends BaseActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    List<Route> mLocalRoute = new ArrayList<>();
    String mDuration;
