...
import com.hrtgo.heritagego.heritagego.Adapter.rcvHomeAdapterTabMyFavorite;
import com.hrtgo.heritagego.heritagego.Model.LocationHome;
import com.hrtgo.heritagego.heritagego.R;

import java.util.ArrayList;

public class homeTabMyFavorite extends Fragment {
    ...
    private void setRecyclerView(){
        ...
        final rcvHomeAdapterTabMyFavorite adapter = new rcvHomeAdapterTabMyFavorite(locationMyfavorite, getActivity());
