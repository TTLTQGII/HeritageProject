...
public class rcvAdapterTabFamousHome extends RecyclerView.Adapter<rcvAdapterTabFamousHome.viewHolder>{

    ArrayList<LocationHome> locationHomes;
    Context context;

    public rcvAdapterTabFamousHome(ArrayList<LocationHome> locationHomes, Context context) {
