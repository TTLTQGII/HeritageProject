...
import com.hrtgo.heritagego.heritagego.Adapter.rcvHomeAdapterTabMostView;
import com.hrtgo.heritagego.heritagego.Model.LocationHome;
import com.hrtgo.heritagego.heritagego.R;

import java.util.ArrayList;

public class homeTabMostViewed extends Fragment{
    ...
    private void setRecyclerView(){
        ...
        final rcvHomeAdapterTabMostView adapter = new rcvHomeAdapterTabMostView(locationMostViewed, getActivity());
